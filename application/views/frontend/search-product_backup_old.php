      ...
      <div class="container padding-bottom-3x padding-top-2x mb-1">
        <div class="row">
              ...
              <div class="column">
                <div id="lbl_showing" class="shop-sorting">
                  ...
                  <?php if (count($product) > 0) { ?>
                    <span class="text-muted" id="">Showing:&nbsp;</span><span><?= count($product); ?> items</span>
                  <?php } else { ?>
          ...
          foreach ($product as $key => $value) {
            //get table product
            $products_tbl = $this->m_model->selectas('id', $value->id, 'product');
          ...
          $cekWishlist = $this->m_model->selectas2('user', $this->session->userdata('user'), 'product_store', $value->id, 'wishlist');
              ...
              <?php } else if($this->session->userdata('user_role') != 'marketer' && $products_tbl[0]->quantity>0) { ?>
          ...
          {//ini untuk tampilan jika sort product list jalan, karena query pada tampilan product list yang sudah ada (diatas) tidak dapat mensort secara keseluruhan dari product store sekaligus
          //print_r($product);
          //die();
          foreach ($product as $key => $value) {
