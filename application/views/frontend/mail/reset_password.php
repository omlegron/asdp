                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                       ...
                       <hr style="border-width: 5px;color:#545454;line-height:1.5;">
                        <!-- // -->

                        <p id="to">Dear, <?= $name; ?></p>
                        <p>
                          You have received this email because you have forgotten your Account Bazaarplace password.
                          <br>
                          You will no longer be able to log into your account with your old password. To reset your password, please follow the link below.
                          <br>
                          <a href="<?= base_url()."page/forgetpassword?token=".$token_reset_password; ?>" target="_BLANK">
                            <?= base_url()."page/forgetpassword?token=".$token_reset_password; ?>
                          </a>
                          <br>
                          The link active until <?= $valid_date_reset;?>
                        </p>
