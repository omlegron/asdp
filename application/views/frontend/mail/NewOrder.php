      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <?php
            if($status_marketer != null &&  $status_marketer != 0){
              $status_penjual="Marketer";
            }
            else{
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h2 style="float: right;">No Order<br><span style="font-size: 15px;"># <?= $orders[0]->ref; ?></span></h2>
                        ...
                        <table style="border: none;  border-spacing: 0px;">
                            ...
                            ?>
                              <tr>
                                ...
                                <td class="text-center text-lg" style="padding-top:15px;"><?= 'Rp '.number_format($values->price * $values->quantity); ?></td>
                              </tr>
                            <?php } } } ?>
                        </table>
