                    ...
                    <tr>
                      <td>
                       ...
                       <hr style="border-width: 5px;color:#545454;line-height:1.5;">
                        ...
                        <p id="to">Dear, <b><?= $this->session->userdata('user_data')->name; ?></b></p>
                        <p>Anda melakukan permintaan penarikan E-Wallet anda sebesar <b>Rp.<?= number_format($payout);?></b> pada <?=$date;?>.
                        <br>
                        <br>
                        Admin Bazaarplace akan segera memproses permintaan anda secepatnya.
                        <br>
                        <br>
