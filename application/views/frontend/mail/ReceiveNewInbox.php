...
<html>
  <head>
    ...
    <title>New Message on Bazaarplace</title>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h2 style="float: right;">New Message</h2>
                       <hr style="border-width: 1px;color:gray;line-height:1; width:100%;">
                        ...
                        <table class="table no-border">
                          <tr>
                            <td colspan="2">
                              Dear <?=$data_user_receiver->name;?>,
                              <br>
                              you have got New Message on <a href="<?=base_url();?>" target="_blank">Bazaarplace.com</a>
                            </td>
                          </tr>
                          <tr>
                            <td>From</td>
                            <td> <?= $data_user_sender->name;?></td>
                          </tr>
                          <tr>
                            <td>Message</td>
                            <td> <?= $message; ?></td>
