          ...
          <div class="content">
            ...
            <table class="main">
              <tr>
                    ...
                    <tr>
                      <td>
                       ...
                       <hr style="border-width: 5px;color:#545454;line-height:1.5;">
                        ...
                        <p id="to">Dear, <?= $name; ?></p>
                        <p>
                          Selamat Pendaftaran akun Anda sebagai Seller (<b><?=$type_seller;?></b>) telah berhasil dilakukan.
                          <br>
                          Saat ini anda dapat membuka toko untuk menjual produk anda di <a href="<?= base_url();?>" target="_BLANK">Bazaarplace.com.</a>
                        </p>
                ...
                2019 © <a href="<?= base_url();?>" target="_BLANK">Bazaarplace.com</a>
                </p>
                </div>
                </td>
              </tr>
