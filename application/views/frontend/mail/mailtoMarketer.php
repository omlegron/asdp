...
<html>
  <head>
    ...
    <title>New Orders Detail Bazaarplace</title>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <table class="table no-border">
                          <tr>
                            <td colspan="2">
                              Dear <?=$name;?>,
                              <br>
                              Supplier <?=$status;?> permintaan penjualan produk yang Anda ajukan, berikut rincian produknya:
                            </td>
                          </tr>
                        </table>
                        ...
                        <br>
<?php
//$data=array('name'=>$userMkt[0]->name,'lang_product'=>$lang_product, 'img_product'=>$img_product, 'productStore'=>$productStore, 'status'=>$status);
  $profit='Rp '.number_format($productStore[0]->profit);
?>
                        <table style="border: none;  border-spacing: 0px;">
                            <tr style="background: #333; border-radius: 3px; color: #FFF; font-weight: bold;">
                                <td class="text-center" style="width: 65%; text-align:center;">Item</td>
                                <td class="text-center" style="text-align:center;">Profit</td>
                            </tr>
                            <tr>
                              <td>
                                <div class="product-item">
                                  <a class="product-thumb" href="<?= site_url('product/detail/'.$productStore[0]->id.'/').$lang_product[0]->seo; ?>">
                                    <img src="<?= base_url().$img_product[0]->small; ?>" style="width:60px; float:left; padding-right:5px;" alt="Product">
                                  </a>
                                  <div class="product-info" style="padding-top:15px;">
                                    <h4 class="product-title">
                                      <a style="color:gray; text-decoration:none;" href="<?= site_url('product/detail/'.$productStore[0]->id.'/').$lang_product[0]->seo; ?>">
                                        <?= $lang_product[0]->title; ?>
                                      </a>
                                    </h4>
                                  </div>
                                </div>
                              </td>
                              <td class="text-center text-lg" style="padding-top:15px; text-align:center;">
                                <?= $profit; ?>
                              </td>
                            </tr>
                        </table>
