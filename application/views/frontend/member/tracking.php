      ...
      <div class="container padding-bottom-3x mb-1">
        <div class="card mb-3">
          ...
          <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
            <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Shipped Via:</span> FEDEX</div>
            <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Status:</span> Checking Quality</div>
            <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Expected Date:</span> 9th Nov 2018</div>
          </div>
          <div class="card-body">
