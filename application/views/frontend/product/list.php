    ...
    <div class="row">
        ...
        <?php
          ...
          <div class="grid-item">
            ...
            <div class="product-card d-flex flex-column" style="min-height: 410px;">
              ...
              <h3 class="product-title" style="<?php if ($this->session->userdata('user_role2') == 'marketer') { echo "height: 50px;"; }?>">
      ...
      ?>
        ...
        <!--<nav class="pagination">
          ...
          ?>
                <li>
                  <a class="page-link" href="<?= base_url($this->uri->segment(1).'/'.$this->uri->segment(2)).$param_active.'page='.$page_i;?>">
                    <?=$page_i;?>
                  </a>
                </li>
          <?php
