        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-8 order-md-2">
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                ...
                <div class="col-4">
                  <input name="brand" class="form-control" type="text" id="text-input" value="<?= $user_store[0]->brand; ?>" placeholder="Store Name" required="">
                </div>
          ...
          <?php } else { ?>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <a class="btn btn-sm btn-primary" href="<?= site_url('supplier/store?edit=true'); ?>"><?=$this->lang->line('Edit Store');?></a>
              </div>
            </div>
            <hr class="margin-bottom-1x">

              <div class="form-group row">
                <div class="col-2"><?="ID ".$this->lang->line('Store');?></div>
                <div class="col-4">
                  <b><?= $user_store[0]->id; ?></b>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-4">
                <?php
                  if($user_store[0]->logo==''){
                    $image=base_url().'assets/frontend/img/features/04.jpg';
                  }
                  else{
                    $image=site_url('images/store/').$user_store[0]->logo;
                  }
                ?>
                  <img src="<?= $image; ?>">
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-4">
                  <?php
                    if($user_store[0]->banner==''){
                      $image=base_url().'assets/frontend/img/store_default.jpg';
                    }
                    else{
                      $image=site_url('images/store/').$user_store[0]->banner;
                    }
                  ?>
                  <img src="<?= $image; ?>">
                </div>
          ...
          <?php if ($this->input->get('add')) { ?>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group row">
                ...
                <div class="col-4">
                  <input name="url" type="text" class="form-control" placeholder="<?=$this->lang->line('Brand Name');?>" aria-describedby="basic-addon3" value="" required="">
                </div>
              </div>
