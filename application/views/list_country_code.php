<select class="form-control" id="code_country" name="code_country" required="">
  <!-- Countries often selected by users can be moved to the top of the list. -->
  <!-- Countries known to be subject to general US embargo are commented out by default. -->
  <!-- The data-countryCode attribute is populated with ISO country code, and value is int'l calling code. -->
  <option value="" disabled="" selected=""><?=$this->lang->line('Select');?></option>
  ...
  <option data-countryCode="CY" value="90">(+90) Cyprus - North </option>
  <option data-countryCode="CY" value="357">(+357) Cyprus - South </option>
  <option data-countryCode="CZ" value="420">(+420) Czech Republic </option>
  ...
  <option data-countryCode="TJ" value="992">(+992) Tajikistan </option>
  ...
  <option data-countryCode="UZ" value="998">(+998) Uzbekistan </option>
  ...
  <option data-countryCode="VG" value="1">(+1) Virgin Islands - British</option>
  <option data-countryCode="VI" value="1">(+1) Virgin Islands - US </option>
