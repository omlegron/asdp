	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="card">
			<div class="container-fluid">
               ...
               <a href="<?=base_url();?>backend/armada/showEdit/<?= $record->id ?>/<?= $armadaElments->id; ?>/<?= $armadass->id ?>"  class="btn btn-success btn-sm" style="color: #fff">Edit</a>
                &nbsp;<a href="<?=base_url();?>backend/armada/laporan/<?= $record->id ?>/<?= $armadaElments->id; ?>/<?= $armadass->id ?>"  class="btn btn-danger btn-sm" style="color: #fff">Print Out</a>
						</div>
					</div>
